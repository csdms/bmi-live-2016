...
class BmiHeat(object):
    ...
    def update_frac(self, time_frac):
        ...
        self._heat_solver.time_step = time_frac * time_step
        self.update()
        self._heat_solver.time_step = time_step
    ...
    def get_grid_spacing(self, grid_id):
        ...
        return self._heat_solver.spacing
    ...
    def get_time_step(self):
        """Time step of model."""
        return self._heat_solver.time_step
